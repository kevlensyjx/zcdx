...
namespace SolutionWeb.User.ViewModels
{
	public partial class VIEW_POLICY_MAIN_INFO{
		...
		public Nullable<System.DateTime> POLICITY_BEGIN_DT{ get; set; }
		public Nullable<System.DateTime> POLICITY_END_DT{ get; set; }
		public string POLICITY_STOP_REASON{ get; set; }
		public string IS_FILE{ get; set; }
		public Nullable<System.DateTime> FILE_DT{ get; set; }
