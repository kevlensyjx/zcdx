...
namespace SolutionWeb.Common
{
    public class Message
    {
        ...
        /// 选择错误，请选择正确{0}!
        /// </summary>
        public static string OptErrSelect = "请选择正确{0}!";
        /// <summary>
        /// 至少填写一项，{0}{1}至少填写一项
        /// </summary>
        public static string OptAtLeastOne = "{0}、{1}至少填写一项！";

        /// <summary>
        /// 必须项，{0}必须填写!
        /// </summary>
        public static string OptMustInput = "{0}必须填写!";
        /// <summary>
        /// 选择具体数据，请选择具体{0}
        /// </summary>
        public static string OptMustSelect = "请选择具体{0}";
        /// <summary>
        /// 判断大小， {0}不得小于{1},请检查!
        /// </summary>
        public static string OptCanNotLess = "{0}不得小于{1},请检查!";
        /// <summary>
        /// 不在范围内，{0}不在{1}范围内,请检查！
        /// </summary>
        public static string OptNotInRange = "{0}不在{1}范围内,请检查！";
        /// <summary>
        /// 操作提示，提示
        /// </summary>
