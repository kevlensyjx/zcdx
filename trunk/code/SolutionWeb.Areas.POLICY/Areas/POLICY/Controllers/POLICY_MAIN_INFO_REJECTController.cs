...
{
    public class POLICY_MAIN_INFO_REJECTController : BaseController
    {
        // GET: POLICY/POLICY_MAIN_INFO_REJECT
        #region Identity
        private IBaseService bs = null;
        private IUserLogin ul = null;

        public POLICY_MAIN_INFO_REJECTController(IBaseService baseService, IUserLogin userLogin)
        {
            this.bs = baseService;
            this.ul = userLogin;
        }
        ...
        public ActionResult Index()
        {
            ...
            string ControllerUrl = "/api/POLICY/POLICY_MAIN_INFO_REJECT/";
            var viewModel = new
            {
                Permission = new//权限
                {
                    a_list = this.ul.HasPermission("POLICY", "POLICY_MAIN_INFO_REJECT", "List", Common.HttpMethod.Post),
                },
                resx = new
                {
    ...
    public class POLICY_MAIN_INFO_REJECTApiController : BaseApiController
    {
        #region Ioc
        private IBaseService bs = null;
        public POLICY_MAIN_INFO_REJECTApiController(IBaseService baseService)
        {
            this.bs = baseService;
        }
        #endregion
                ...
                bs.Entities<POLICY_STATUS_CHANGE>()
                    .Where(
                        o =>
                            ...
                            o.STATUS_CODE == Constant.POLICY_STATUS.驳回处理);
        ...
        public AjaxMsgModel SaveRejectInfo(POLICY_STATUS_CHANGE model)
        {
            return Model_POLICY_MAIN_INFO.Create.SaveReject(model);
        }
