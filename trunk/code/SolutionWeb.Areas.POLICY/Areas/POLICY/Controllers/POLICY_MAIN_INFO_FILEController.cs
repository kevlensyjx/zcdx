...
{
    public class POLICY_MAIN_INFO_FILEController : BaseController
    {
        // GET: POLICY/POLICY_MAIN_INFO_FILE
        #region Identity
        private IBaseService bs = null;
        private IUserLogin ul = null;

        public POLICY_MAIN_INFO_FILEController(IBaseService baseService, IUserLogin userLogin)
        {
            this.bs = baseService;
            this.ul = userLogin;
        }
        ...
        public ActionResult Index(string id)
        {
            ...
            string ControllerUrl = "/api/POLICY/POLICY_MAIN_INFO_FILE/";
            var viewModel = new
            {
                Permission = new//权限
                {
                    a_list = this.ul.HasPermission("POLICY", "POLICY_MAIN_INFO_FILE", "List", Common.HttpMethod.Post),
                    a_selectdel = this.ul.HasPermission("POLICY", "POLICY_MAIN_INFO_FILE", "List", Common.HttpMethod.Post),
                ...
                urls = new//请求URL
                {
                    ...
                    selectpolicity = ControllerUrl + "SelectFile",
    ...
    public class POLICY_MAIN_INFO_FILEApiController : BaseApiController
    {
        #region Ioc
        private IBaseService bs = null;
        public POLICY_MAIN_INFO_FILEApiController(IBaseService baseService)
        {
            this.bs = baseService;
        }
        #endregion
        ...
        public ViewModel List(VIEW_POLICY_STATUS_CHANGE data)
        {
            ...
            //{
            statusEntites = statusEntites.Where(o => o.STATUS_CODE == Constant.POLICY_STATUS.备案归档);
            //}
        ...
        #region 多选归档
        [HttpPost]
        public AjaxMsgModel SelectFile(object PKID)
        {
            AjaxMsgModel amm = new AjaxMsgModel();
            List<string> listHouseId = PKID.ToString().Split(',').ToList();
            return Model_POLICY_MAIN_INFO.Create.SelectFile(listHouseId);
        }
        #endregion
    }
}