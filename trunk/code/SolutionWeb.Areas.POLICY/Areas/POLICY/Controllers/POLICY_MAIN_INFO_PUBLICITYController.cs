...
{
    public class POLICY_MAIN_INFO_PUBLICITYController : BaseController
    {
        // GET: POLICY/POLICY_MAIN_INFO_PUBLICITY
        #region Identity
        private IBaseService bs = null;
        private IUserLogin ul = null;

        public POLICY_MAIN_INFO_PUBLICITYController(IBaseService baseService, IUserLogin userLogin)
        {
            this.bs = baseService;
            this.ul = userLogin;
        }
        ...
        public ActionResult Index(string id)
        {
            ...
            string ControllerUrl = "/api/POLICY/POLICY_MAIN_INFO_PUBLICITY/";
            var viewModel = new
            {
                Permission = new//权限
                {
                    a_list = this.ul.HasPermission("POLICY", "POLICY_MAIN_INFO_PUBLICITY", "List", Common.HttpMethod.Post),
                    a_selectdel = this.ul.HasPermission("POLICY", "POLICY_MAIN_INFO_PUBLICITY", "List", Common.HttpMethod.Post),
                ...
                urls = new//请求URL
                {
                    ...
                    selectpolicity = ControllerUrl + "SelectPolicity",
    ...
    public class POLICY_MAIN_INFO_PUBLICITYApiController : BaseApiController
    {
        #region Ioc
        private IBaseService bs = null;
        public POLICY_MAIN_INFO_PUBLICITYApiController(IBaseService baseService)
        {
            this.bs = baseService;
        }
        #endregion
        ...
        public ViewModel List(VIEW_POLICY_STATUS_CHANGE data)
        {
            ...
            IQueryable<POLICY_STATUS_CHANGE> statusEntites = bs.Entities<POLICY_STATUS_CHANGE>().Where(o => o.DEPT_CODE.Equals(oc.CurrentUser.DEPT_CODE) && o.IS_HANDLE == "0");
            ...
            //{
            statusEntites = statusEntites.Where(o => o.STATUS_CODE == Constant.POLICY_STATUS.事项公示);
            //}
        ...
        #region 多选公示
        [HttpPost]
        public AjaxMsgModel SelectPolicity(object PKID)
        {
            AjaxMsgModel amm = new AjaxMsgModel();
            List<string> listHouseId = PKID.ToString().Split(',').ToList();
            return Model_POLICY_MAIN_INFO.Create.SelectPolicity(listHouseId);
        }
        #endregion
    }
}